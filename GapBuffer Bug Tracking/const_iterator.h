...
class GapBuffer::const_iterator {
  public:
	...
	//~const_iterator() { delete gap_start; delete gap_end; };
	...
	inline const_iterator operator+(size_type) const;
	inline const_iterator operator-(size_type) const;
	inline const const_iterator& operator-=(size_type);
	inline const const_iterator& operator+=(size_type);
	inline const_reference operator[](size_type) const;
	inline const const_iterator& operator=(const const_iterator&);
  ...
  private:
	bool IsBelongToBuffer(vec_char_citer) const;
